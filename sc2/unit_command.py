...
class UnitCommand:
    def __init__(self, ability: AbilityId, unit: Unit, target: Unit | Point2 = None, queue: bool = False) -> None:
        """
        :param ability:
        :param unit:
        :param target:
    ...
    @property
    def combining_tuple(self) -> tuple[AbilityId, Unit | Point2, bool, bool]:
